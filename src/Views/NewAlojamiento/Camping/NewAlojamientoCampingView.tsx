...
import CampingForm from "./Forms/CampingForm/CampingForm";
...
type TNewAlojamientoCampingView = {
  idOferta: string;
};
export default function NewAlojamientoCampingView(
  props: TNewAlojamientoCampingView
) {
  ...
  return (
    <>
      ...
      >
        {segment == "alojamiento-form" && <CampingForm id={props.idOferta} />}
