...
import { Input, NumberInput } from "../../../../../components/ui/Input/Input";
...
export default function AlojamientoForm(props: TAlojamientoForm) {
  ...
  const { datosRegistroAlojamiento, alojamientoForm, alojamientoSchema } =
    useAlojamientoIndividual();
  const form = alojamientoForm;
  const formWatch = form.watch();
      ...
      <Form {...form}>
        <form onSubmit={() => {}} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="p-4 border border-gray-200 bg-gray-50 rounded-md text-xl text-gray-600 font-bold">
              Cantidad de plazas
            </div>
            <FormField
              control={form.control}
              name="cantidad_cama_doble"
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input
                      label="Cama doble:"
                      placeholder="Cama doble"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              control={form.control}
              name="cantidad_cama_individual"
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input
                      label="Cama individual:"
                      placeholder="Cama individual"
                      {...field}
                    />
                  </FormControl>
                  <FormMessage />
            ...
            <div className="flex flex-row gap-2 p-4 border border-[#bbb] rounded-sm text-gray-600">
              <span className="font-bold">Total de plazas:</span>
              {Number(
                (formWatch.cantidad_cama_doble ?? 0) +
                  (formWatch.cantidad_cama_individual ?? 0) +
                  (formWatch.cantidad_sofa_cama ?? 0)
              )}
            </div>
            ...
            <div className="flex flex-row w-full gap-4 items-center">
              ...
              />
              <Check
                className="h-[42pt] w-full break-inside-avoid-column"
                checked={formWatch.baño_adaptado}
          ...
          <div className="flex flex-col gap-2">
            <div className="p-4 border border-gray-200 bg-gray-50 rounded-md text-2xl text-gray-600 font-bold">
              Comodidades y servicios de la vivienda
            </div>
            <div className="columns-3 gap-2">
              <CheckSection
