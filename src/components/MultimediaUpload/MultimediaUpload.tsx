		...
		<>
			...
			>
				{mediaList.map(
					(media: TMedia) =>
						media.state == "loading" && (
							<LoadingImage src={media.file} />
						)
				)}
				{mediaList.map(
					(media: TMedia) =>
						media.state == "failed" && (
							<FailedImage src={media.file} />
						)
				)}
				{mediaList.map(
					(media: TMedia) =>
			...
			>
				<div className="wrapper">
					...
					>
						...
						<IonRow
							style={{ justifyContent: "center", padding: "8pt" }}
						>
							{selectedFromServer && (
								<img
									src={
						...
						>
							...
							<IonButton
								...
								onClick={() =>
									selectedFromServer &&
									handleEliminar(selectedFromServer)
								}
							>
								Eliminar imagen
							</IonButton>
